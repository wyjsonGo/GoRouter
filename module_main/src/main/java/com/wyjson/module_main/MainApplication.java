...
public class MainApplication implements IApplication {
    ...
    public void init(Application app) {
        GoRouter.getInstance().build(MainRoute.SplashActivity).commitActivity(SplashActivity.class);
        GoRouter.getInstance().build(MainRoute.MainActivity).commitActivity(MainActivity.class);
        GoRouter.getInstance().build(MainRoute.DocumentFragment).commitFragment(DocumentFragment.class);
    }
